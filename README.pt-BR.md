...
2. **Adicione as variáveis de ambiente**
   ...
   > **Limites de uso da API Gemini:** As cotas e limites de taxa variam de acordo com o modelo e o nível de uso. Consulte a [documentação oficial de limites de taxa da API Gemini](https://ai.google.dev/gemini-api/docs/rate-limits) para conferir os limites atuais de requisições e tokens antes de selecionar ou alterar `GEMINI_MODEL`.
